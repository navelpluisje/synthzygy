...
import { inputTypes } from './logicOr.inputs';
import { OrNode } from './logicOr.node';
import { outputTypes } from './logicOr.outputs';

export class LogicOr extends ModuleBase implements ParentModule {
  ...
  constructor(
    ...
    this.node = new OrNode(context);
    this.container = new SynthModule(canvas, LogicOr.dimensions, position, this.color);
